...
typedef std::unordered_set<CTMqttClientContext_ptr> CONTEXT_SET;
...
class CTopicNode
{
	...
	int add_client(CTMqttClientContext_ptr &cli_context)
	{
	...
	int del_client(CTMqttClientContext_ptr &cli_context)
	{
...
class CSubscriberMgr
{
    ...
    int add_client_context(std::string str_topic_name, CTMqttClientContext_ptr cli_context)
    {
    ...
    int del_client_context(std::string &str_topic_name, CTMqttClientContext_ptr & cli_context)
    {
	 auto it = m_topic_mgr.find(str_topic_name);
