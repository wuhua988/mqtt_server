...
namespace reactor
{
    ...
    int TCPClient::handle_input(socket_t socket)
    {
    ...
    int TCPClient::handle_timeout(uint32_t time, void *data)
    {
        // reconnect again
    ...
    int TCPClient::handle_output(socket_t socket)
    {
    ...
    int TCPClient::handle_close(socket_t socket)
    {
        this->close();
